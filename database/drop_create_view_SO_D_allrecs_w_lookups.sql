...
-- Uncomment these if we need to drop/create the view, or add IF EXISTS to each one:
--EXEC sys.sp_dropextendedproperty @name=N'MS_DiagramPaneCount' , @level0type=N'SCHEMA',@level0name=N'SO', @level1type=N'VIEW',@level1name=N'view_SO_D_allrecs_w_lookups'
--GO

--EXEC sys.sp_dropextendedproperty @name=N'MS_DiagramPane2' , @level0type=N'SCHEMA',@level0name=N'SO', @level1type=N'VIEW',@level1name=N'view_SO_D_allrecs_w_lookups'
--GO

--EXEC sys.sp_dropextendedproperty @name=N'MS_DiagramPane1' , @level0type=N'SCHEMA',@level0name=N'SO', @level1type=N'VIEW',@level1name=N'view_SO_D_allrecs_w_lookups'
--GO

/****** Object:  View [SO].[view_SO_D_allrecs_w_lookups]    Script Date: 1/3/2024 8:08:17 AM ******/
DROP VIEW IF EXISTS [SO].[view_SO_D_allrecs_w_lookups]
GO
...
CREATE VIEW [SO].[view_SO_D_allrecs_w_lookups]
AS
SELECT        sod.PHOTO_FILE_NAME, FORMAT(sod.PHOTO_TIMESTAMP_UTC, 'yyyy-MM-dd HH:mm:ss') AS PHOTO_TIMESTAMP_UTC, FORMAT(sod.PHOTO_TIMESTAMP_AK_Local, 'yyyy-MM-dd HH:mm:ss') AS PHOTO_TIMESTAMP_AK_Local, sod.LATITUDE_WGS84, sod.LONGITUDE_WGS84, sod.ALTITUDE, st.SURVEY_TYPE, sod.COUNT_ADULT, 
                         ...
                         q.DEFINITION AS QUALITY_FLAG, sod.ORIGINAL_FILENAME, f.INITIALS AS FLOWN_BY, c.DESCRIPTION AS CAMERA_SYSTEM, v.INITIALS AS VALIDATED_BY, FORMAT(sod.DATE_CREATED, 'yyyy-MM-dd HH:mm:ss') 
